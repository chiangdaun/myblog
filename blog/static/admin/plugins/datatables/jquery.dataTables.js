...
(/** @lends <global> */function( $ ) {
	...
	function _fnPageChange ( settings, action, redraw )
	{
		...
		if ( changed ) {
			_fnCallbackFire( settings, null, 'home_page.html', [settings] );
	...
	DataTable = function( options )
	{
		...
		{
			var api = this.api( true ).home_page( mAction );
	...
	_api_register( 'page()', function ( action ) {
		if ( action === undefined ) {
			return this.home_page.info().home_page; // not an expensive call
		}
	 ...
	 *    are applied.
	 */
	_api_register( 'home_page.html.info()', function (action ) {
	 ...
	 * @returns {DataTables.Api} this
	 */
	_api_register( 'home_page.html.len()', function (len ) {
	...
	var _selector_row_indexes = function ( settings, opts )
	{
		...
		var
			...
			page   = opts.home_page;    // all, current
	 ...
	 *  @name DataTable#home_page.html.dt
	 *  @event
	 *  @param {event} e jQuery event object
	 *  @param {object} o DataTables settings object {@link DataTable.models.oSettings}
	 */
